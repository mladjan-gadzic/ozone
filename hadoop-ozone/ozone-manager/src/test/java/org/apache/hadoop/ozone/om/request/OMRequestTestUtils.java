...
public final class OMRequestTestUtils {
  ...
  private static OmKeyInfo createOmKeyInfo(String volumeName, String bucketName,
    ...
    return createOmKeyInfo(volumeName, bucketName, keyName, replicationType,
        replicationFactor, objectID, parentID, trxnLogIndex, creationTime,
        version, isMultipartKey, new ArrayList<>());
  }
   ...
   */
  @SuppressWarnings("parameterNumber")
  public static OmKeyInfo createOmKeyInfo(
      String volumeName, String bucketName,
      String keyName,
      HddsProtos.ReplicationType replicationType,
      HddsProtos.ReplicationFactor replicationFactor,
      long objectID,
      long parentID, long trxnLogIndex,
      long creationTime, long version,
      boolean isMultipartKey,
      List<OmKeyLocationInfo> infos) {
    ...
    return new OmKeyInfo.Builder()
        ...
        .setKeyName(keyName)
        .setOmKeyLocationInfos(Collections.singletonList(
            new OmKeyLocationInfoGroup(version, infos,
                isMultipartKey)))
        .setCreationTime(creationTime)
        .setModificationTime(Time.now())
        .setDataSize(1000L)
